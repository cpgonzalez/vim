...
" This disables arrow key navigation in default mode. add i to the map's to
" also disable these keys in insert mode (bad idea!!) 
map <up> <nop>
map <down> <nop>
map <left> <nop>
map <right> <nop>
...
unlet s:cpo_save
set background=dark
" allow backsapce to delete previously entered characters
set backspace=2
